...
output "network_acl_public_ipv4_ids"  { value = "${aws_network_acl.public.id}"                            description = "Network ACL public ID" }
output "network_acl_private_ipv4_ids" { value = "${aws_network_acl.private.id}"                           description = "Network ACL private ID" }
output "network_acl_public_ipv6_ids"  { value = "${aws_network_acl.public_ipv6.id}"                       description = "Network ACL public IPv6 ID" }
output "network_acl_private_ipv6_ids" { value = "${aws_network_acl.private_ipv6.id}"                      description = "Network ACL private IPv6 ID" }
